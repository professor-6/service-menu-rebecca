...
psqlClient.connect(()=>{
  ...
  'menu_selection( id int  PRIMARY KEY NOT NULL,  BREAKFAST text NOT NULL, LUNCH text NOT NULL, DINNER text NOT NULL, BRUNCH text NOT NULL, HAPPYHOUR text NOT NULL)';
  psqlClient.query(schemaGeneration)
    .then(res => console.log('post gres running with table generated'))
